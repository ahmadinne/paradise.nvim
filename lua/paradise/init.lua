local bufferline = require("paradise.integrations.bufferline")
local cmp = require("paradise.integrations.cmp")
local colorscheme = require("paradise.colorscheme")
local config = require("paradise.config")
local utils = require("paradise.utils")
local theme = {}
...
function theme.colorscheme()
	if vim.version().minor < 8 then
		vim.notify("Neovim 0.8+ is required for paradise colorscheme", vim.log.levels.ERROR, { title = "Min Theme" })
		return
	end
